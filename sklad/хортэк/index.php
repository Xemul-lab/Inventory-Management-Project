...
<body>
	<div class="container">
		<div class="row">
			<div class="col mt-1">
				...
				<button class="btn btn-success mb-1" data-toggle="modal" data-target="#Euro"><i class="fa fa-eur"></i></button>
				<hr class="bg-danger border-2 border-top border-danger">
				<a href="http://localhost/клиенты/" class="btn btn-primary btn-lg" tabindex="-1" role="button">Учет клиентов</a>
				<a href="http://localhost/склад/" class="btn btn-primary btn-lg" tabindex="-1" role="button">Товары на складе</a>
				<hr class="bg-danger border-2 border-top border-danger">
				<a href="http://localhost/виега/" class="btn btn-primary btn-lg" tabindex="-1" role="button">Виега</a>
				<a href="http://localhost/товар1/" class="btn btn-primary btn-lg" tabindex="-1" role="button">товар1</a>
				<a href="http://localhost/товар2/" class="btn btn-primary btn-lg" tabindex="-1" role="button">товар2</a>
				<a href="http://localhost/товар3/" class="btn btn-primary btn-lg" tabindex="-1" role="button">товар3</a>
	    ...
	    <div class="modal-content shadow">
	      ...
	      <div class="modal-body">
	        ...
	        <form action="" method="post">
	        	...
	        	<div class="md-form">
	        		<input type="number" step="any" class="form-control" name="price" value="" placeholder="Стоимость товара">
	        	</div>
	  	  </div>
	    ...
	    <div class="modal-content shadow">
	      ...
	      <div class="modal-body">
	         <form action="" method="post">
	        	...
	        	<div class="md-form">
	        		<input type="tel" class="form-control" name="phone" value="" placeholder="Телефон(вводить при новом клиенте)">
	        	</div>
	        	<div class="form-group">
	        		<input type="email" class="form-control" name="email" value="" placeholder="email(вводить при новом клиенте)">
	        	</div>
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="address" value="" placeholder="Адрес(вводить при новом клиенте)">
	        	</div>
	  	  </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
	...
	<div class="modal fade" tabindex="-1" role="dialog" id="Euro">
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content shadow">
	      <div class="modal-header">
	      ...
	      <div class="modal-body">
	        ...
	        <form action="" method="post">
	        	<div class="md-form">
	        		<input type="number" class="form-control" name="euro-price" step="any" value="" placeholder="Стоимость евро" >
	        	</div>
	  	  </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">Отмена</button>
	        <button type="submit" name="euro-submit" class="btn btn-primary">Добавить</button>
	      </div>
	  		</form>
	    </div>
	  </div>
