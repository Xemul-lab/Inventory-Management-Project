    ...
    <div class="modal-content shadow">
      ...
      <div class="modal-body">
        <form action="?id=<?=$value['id'] ?>" method="post">
          ...
          <div class="form-group">
            <input type="text" class="form-control" name="edit_namename" 
            value="<?=$value['namename']?>" placeholder="Название товара">
          </div>
        	<div class="md-form">
        		<input type="number" class="form-control" name="edit_code" value="<?=$value['code'] ?>" placeholder="Штрихкод">
        	</div>
          <div class="md-form">
            <input type="number" class="form-control" name="edit_quantityskl" value="<?=$value['quantityskl'] ?>" placeholder="Кол-во товара">
          </div>
          <div class="md-form">
            <input type="number" class="form-control" name="edit_quantitysold" value="<?=$value['quantitysold'] ?>" placeholder="Кол-во товара">
          </div>
          <div class="md-form">
            <input type="number" class="form-control" name="edit_price" value="<?=$value['price'] ?>" placeholder="Цена">
          </div>
